...
const STEPS = [
  ...
  },
  {
    ...
    body: 'En PLAN ves todo el mes de un vistazo. Activa ⇄ para intercambiar sesiones: toca el día que quieres mover y luego el día con el que intercambiar.',
    cardPos: 'mid',
  ...
  {
    icon: '📊',
    title: 'Tu estado de forma',
    body: 'En YO revisa tu evolución: ritmo fácil, umbrales y tiempos estimados por distancia. Conecta Strava para sincronizar tus actividades automáticamente.',
    cardPos: 'mid',
  ...
  },
  {
    icon: '🏆',
    title: '¡Todo listo!',
    body: 'La IA analiza tus sesiones y ajusta el plan cada semana. Cuanto más registres, más preciso y personalizado será tu entrenamiento.',
    cardPos: 'center',
    spotFn: null,
    tail: null,
    tailTabFn: null,
